...
public class MysqlRequest {
	...
	public static boolean checkProjectId(final String projetId, String studentId) throws SQLException {
		final String request = "SELECT * FROM javacorrectdb.EVALUATION " + "WHERE PROJET_idProjet=? "
				+ "AND ETUDIANT_numEtu IN " + "(SELECT * FROM (SELECT numetu " + "FROM javacorrectdb.ETUDIANT "
				+ "WHERE idEtu=?) " + "AS subquery);";
